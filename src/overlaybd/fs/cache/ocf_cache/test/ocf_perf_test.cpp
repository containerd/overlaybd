...
#include "../../../../photon/syncio/signal.h"
#include "../../../../photon/thread.h"
#include "../../../../photon/thread11.h"
#include "../../../../alog.h"
#include "../../../../event-loop.h"
#include "../../../../fs/filesystem.h"
#include "../../../../fs/zfile/crc32/crc32c.h"
...
static int single_file_test(IOAlloc* io_alloc) {
    ...
    auto src_fs = FileSystem::new_localfs_adaptor("/", FLAGS_io_engine);
    if (src_fs == nullptr) {
...
static FileSystem::IFileSystem* prepare_copied_fs(IOAlloc* io_alloc, const std::string& root_dir) {
    ...
    auto urandom_file = FileSystem::open_localfile_adaptor("/dev/urandom", O_RDONLY, 0644);
...
static int multiple_files_test(IOAlloc* io_alloc) {
    ...
    auto src_fs = FileSystem::new_localfs_adaptor(root_dir.c_str(), FileSystem::ioengine_libaio);
    if (src_fs == nullptr) {
        LOG_ERROR_RETURN(0, -1, "failed to create fs");
    }
    DEFER(delete src_fs);
