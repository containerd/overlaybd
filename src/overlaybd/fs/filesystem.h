...
public:
    ...
    FuncPIO _and_pwrite() {
        return (FuncPIO)&IFile::pwrite;
    }
    bool is_readf(FuncPIO f) {
        return f == _and_pread();
    }
    bool is_writef(FuncPIO f) {
        return f == _and_pwrite();
    }
    ...
    FuncPIOV_mutable _and_preadv_mutable() {
        return &IFile::preadv_mutable;
    }
    FuncPIOV_mutable _and_pwritev_mutable() {
        return &IFile::pwritev_mutable;
    }
    bool is_readf(FuncPIOV_mutable f) {
        return f == _and_preadv_mutable();
    }
    bool is_writef(FuncPIOV_mutable f) {
        return f == _and_pwritev_mutable();
    }
    ...
    FuncPIOCV _and_preadcv() {
        return &IFile::preadv;
    }
    FuncPIOCV _and_pwritecv() {
        return &IFile::pwritev;
    }
    bool is_readf(FuncPIOCV f) {
        return f == _and_preadcv();
    }
    bool is_writef(FuncPIOCV f) {
        return f == _and_pwritecv();
    }
};
...
struct FileList {
    DIR *dirp;
    bool autoDelete;
    FileList(DIR *dirp, bool autoDelete = false) : dirp(dirp), autoDelete(autoDelete) {
    }
    ~FileList() {
        if (autoDelete)
            delete dirp;
